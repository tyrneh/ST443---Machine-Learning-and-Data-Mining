...
tree_carseats <- tree(High ~ . - Sales, data = Carseats1)
...
text(tree_carseats, pretty = 0, cex = 0.8)
...
tree_pred <-predict(tree_carseats, newdata = Carseats_test, type="class")
## Confusion matrix
...
#plotting the optimal tree size
par(mfrow=c(1,2))
...
dim(Boston) #Boston has 13 predictors
...
) #n.trees is the value of B, and interaction.depth is the value of d
...
# these show the marginal effects of the variables
