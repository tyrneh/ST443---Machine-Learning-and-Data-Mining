...
Check whether the classes are linarly separable -- They are not:
```{r}
...
A cost argument allow us to specifiy the cost of a violation to the margin. When the cost argument is small, the margins will be wide and many support vectors will be on the margin or will violate the margin. (You can play with smaller values of the cost argument, cost = 0.1)
```{r}
...
Read and understand the code by yourself if you donot like the plot function in the `1071` package.
